...
static constexpr auto FEELER_INTERVAL = 1s;
...
static const int MAX_OUTBOUND_FULL_RELAY_CONNECTIONS = 8000;
...
static const unsigned int DEFAULT_MAX_PEER_CONNECTIONS = 2500;
